...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{../Thesis/figures/algorithms/neu_mf.png}
...
Come metriche di valutazione si possono usare la \textit{AUC}~\ref{evaluation} o \textit{Hit@K}~\ref{evaluation}.
